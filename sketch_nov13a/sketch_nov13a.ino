...
// WiFi settings
const char* ssid = "frenz";               // Ganti dengan SSID jaringan Anda
const char* password = "frenz1975";      // Ganti dengan password WiFi Anda
...
const char* pub_lampu = "status175/lampu";
const char* pub_relay = "status175/relay";
const char* pub_buzzer = "status175/buzzer";
const char* sub_suhu = "sensor175/suhu";
const char* sub_humi = "sensor175/kelembapan";
const char* sub_turbidity = "sensor175/kekeruhan";
const char* sub_ph = "sensor175/ph";

// Alamat URL Flask server
const char* flask_server_url = "http://192.168.26.248:4040/data";  // Ganti <NGROK_URL> dengan URL ngrok yang digunakan
...
void sendToFlask(float suhu, float humidity) {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    String jsonData = "{\"suhumax\":50,\"suhumin\":35,\"suhurata2\":42.5,\"nilaisuhuhumid\":[{\"id\":1,\"suhu\":" 
